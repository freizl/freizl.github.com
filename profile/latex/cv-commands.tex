...
% small caps
\newcommand{\smcp}[1]{{\font\1="Monaco:+smcp" at 11pt \1{#1}}}
...
\newcommand{\headline}[1]{ {\font\1="Monaco" at 20pt \1{#1}}}
\newcommand{\setmainfont}[0]{\font\x="Monaco" at 12pt \x}

%%%%%%

\newenvironment{resumeblock}[1]
{\blocktitle{#1}\begin{tabular}{p{4cm}p{13cm}}}
{\end{tabular}}
